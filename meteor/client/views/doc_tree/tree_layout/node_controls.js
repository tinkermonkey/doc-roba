 ...
 * @constructor
 */
TreeNodeControls = function (treeLayout, config) {
  var self = this;
 ...
 * @param d
 */
TreeNodeControls.prototype.getRadius = function (d) {
 ...
 */
TreeNodeControls.prototype.generateDraggerOutline = function () {
  var self = this,
    tree = self.treeLayout,
    d = self.node;
 ...
 */
TreeNodeControls.prototype.generateDragTetherPath = function () {
  var self = this,
    d = self.node,
    path = 'M0,0',
    point,
