 ...
 */
MapLayout = function (elementId, context, config) {
  var self = this;
...
MapLayout.prototype.init = function () {
  ...
  Meteor.log.info("MapLayout.init");
 ...
 */
MapLayout.prototype.prepData = function () {
  var self = this;
 ...
 */
MapLayout.prototype.updateSize = function () {
  var self = this;
 ...
 * Resize to fix the window
 */
MapLayout.prototype.resize = function () {
  var self = this;
 ...
 */
MapLayout.prototype.cacheView = function () {
  this.viewCache = {
    scale: this.scale,
 ...
 */
MapLayout.prototype.restoreCachedView = function (duration, callback) {
  if(this.viewCache){
 ...
 * @returns {*}
 */
MapLayout.prototype.screenToLocalCoordinates = function(point){
  var p = _.clone(point);
 ...
 * @returns {*}
 */
MapLayout.prototype.localToScreenCoordinates = function(point){
  var p = _.clone(point);
 ...
 * @param rect
 */
MapLayout.prototype.fitAndCenter = function(rect, duration, callback){
 ...
 * @param rect
 */
MapLayout.prototype.zoomAndCenter = function(rect, scale, duration, callback){
  //Meteor.log.debug("Zoom and center");
 ...
 */
MapLayout.prototype.scaleAndTranslate = function (scale, translation, duration, callback) {
  var self = this;
 ...
 * @param callback
 */
MapLayout.prototype.centerNode = function (node, scale, callback) {
  var self = this;
  ...
  if(_.isString(node)){
    ...
    if(!node){
      Meteor.log.error("centerNode: failed to find node by static id");
      return;
    }
  }
 ...
 */
MapLayout.prototype.clearCenteredNode = function (callback) {
  var self = this;
 ...
 */
MapLayout.prototype.zoomAll = function (duration, callback) {
  var self = this;
 ...
 */
MapLayout.prototype.transitionView = function (rect, finalWidth, finalHeight, duration, callback) {
  var self = this,
    margin = DocTreeConfig.tree.highlightSurroundMargin / 2,
    contentWindow = {
      x: margin,
 ...
 */
MapLayout.prototype.transitionZoomAll = function (finalWidth, finalHeight, duration, callback) {
  var self = this,
    rect = {
      x: self.contentBounds.left,
      y: self.contentBounds.top,
 ...
 */
MapLayout.prototype.showLocationUnknown = function () {
  var self = this;
 ...
 * Show the location unknown content
 */
MapLayout.prototype.hideLocationUnknown = function () {
  var self = this;
 ...
 * @param node
 */
MapLayout.prototype.showNodeActions = function (node) {
  var self = this;
 ...
 * @param d
 */
MapLayout.prototype.nodeClickFilter = function (d) {
 ...
 */
MapLayout.prototype.nodeClickHandler = function(e, d){
  var self = this;
 ...
 */
MapLayout.prototype.nodeDblClickHandler = function(e, d){
 ...
 * @param d
 */
MapLayout.prototype.nodeMouseEnterHandler = function (d) {
  var self = this;
 ...
 * @param d
 */
MapLayout.prototype.nodeMouseLeaveHandler = function (d) {
  var self = this;
 ...
 * @param d
 */
MapLayout.prototype.actionClickHandler = function (d) {
  var self = this,
    event = d3.event;
 ...
 * @param d
 */
MapLayout.prototype.actionRightClickHandler = function (d) {
  var self = this;
};
 ...
 * @param d
 */
MapLayout.prototype.actionMouseEnterHandler = function (d) {
 ...
 * @param d
 */
MapLayout.prototype.actionMouseLeaveHandler = function (d) {
 ...
 */
MapLayout.prototype.updateContentBounds = function () {
 ...
 */
MapLayout.prototype.update = function (duration) {
  var self = this;
 ...
 * @param nodeList The list of node staticIds to highlight
 */
MapLayout.prototype.highlightNodes = function (nodeIdList) {
  var self = this,
    nodeList = [], nodes;
  ...
  nodes = self.highlightLayer.selectAll(".node-highlight")
    .data(nodeList, function (d) { return d._id; });
  ...
  nodes.enter()
    ...
    .attr("r", function (d) { return Math.sqrt(Math.pow(d.icon.right, 2) + Math.pow(d.icon.bottom, 2)) + 10 });
 ...
 * Clear the highlight
 */
MapLayout.prototype.clearHighlight = function () {
  var self = this;
